"""
KRS Business Logic Module
Manages the core operations for the Course Registration System (KRS)
"""
...
def submit_krs(nim: str, semester: str, db: Session) -> bool:
    ...
    try:
        ...
        if krs.status != KRSStatusEnum.DRAFT:  # Use the direct enum import
...
def approve_krs(nim: str, semester: str, dosen_pa_id: Optional[int], db: Session) -> bool:
    ...
    try:
        ...
        if krs.status != KRSStatusEnum.SUBMITTED:  # Use the direct enum import
