...
# Import models and other modules AFTER engine is created
import models
...
# Create a test-specific database session getter
def get_test_db():
...
# Import and configure a test version of the app
...
def db_session():
    ...
    # Create all tables in this connection
...
def test_register_success(client, db_session):
    ...
    print(f"SUCCESS: Registered applicant with ID {data['id']}")
