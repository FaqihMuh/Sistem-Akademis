...
def test_calon_mahasiswa_model():
    ...
    assert CalonMahasiswa.validate_phone_format('0812345678') == False  # 10 digits minimum, but this is exactly 10 - should be valid
    assert CalonMahasiswa.validate_phone_format('08123456789012') == True  # 13 digits maximum
    assert CalonMahasiswa.validate_phone_format('081234567890123') == False  # 14 digits - too long
